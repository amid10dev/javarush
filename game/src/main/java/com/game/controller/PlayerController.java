...
public class PlayerController {
    ...
    public Integer getPlayersCount(
        ...
        return playerService.getPlayers(name,title,race,
                profession,after,before,banned,minExperience,maxExperience,minLevel,maxLevel).size();
    ...
    public ResponseEntity<Player> createPlayer(@RequestBody Player player) {
        ...
        final int level = playerService.levelRating(player.getExperience());
        player.setLevel(level);


        player.setUnitNextLevel(player.getUnitNextLevel());
        final int nextLevel = playerService.experienceNextLevel(player.getLevel(),player.getExperience());
        player.setUnitNextLevel(nextLevel);
